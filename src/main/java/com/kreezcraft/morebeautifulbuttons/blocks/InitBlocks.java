...
public class InitBlocks {
	...
	public static final LightButton GLOWSTONE_BUTTON = new LightButton("glowstone_button");
	//
	//
	...
	public static final LightButton MAGMA_BUTTON = new LightButton("magma_button");
